...
As a next project, we'll train a model on a cloud GPU, and convert it for usage in Tensorflow.js. Using [Google Colab](https://colab.research.google.com), you can use a cloud GPU for free to run Python scripts. Which is perfect for AI related tasks.
